    ...
    <div className="relative min-h-screen bg-gradient-to-br from-orange-500 via-orange-400 to-red-500 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fadeIn mb-12" style={{ animationDelay: '0.6s' }}>
          ...
          <button
            onClick={cta1Action}
            className="relative group px-10 py-4 bg-white text-orange-600 font-bold text-lg rounded-2xl shadow-2xl hover:shadow-orange-300/50 hover:scale-110 transition-all duration-300 flex items-center gap-2 shine-effect"
          >
            <ShoppingBag className="w-5 h-5" />
            {cta1Text}
            <ArrowRight className="w-5 h-5 animate-float-arrow opacity-0 group-hover:opacity-100 transition-opacity" />
          </button>
