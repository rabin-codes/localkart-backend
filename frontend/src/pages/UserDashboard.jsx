...
import { Card, Button, Modal, Loader2 } from '../components';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-8">
          <h2 className="text-2xl font-bold text-secondary mb-4">Explore New Features</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-orange-500" onClick={() => navigate('/combo-builder')}>
              <h3 className="text-lg font-bold text-gray-800">Combo Builder 🍔</h3>
              <p className="text-sm text-gray-600 mt-2">Build a custom multi-shop Combo Order to save on delivery fees.</p>
            </Card>
            
            <Card className="hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-blue-500" onClick={() => navigate('/predictions')}>
              <h3 className="text-lg font-bold text-gray-800">AI Needs Predictor 🤖</h3>
              <p className="text-sm text-gray-600 mt-2">Our AI predicts what essential items you are likely running out of.</p>
            </Card>

            <Card className="hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-purple-500" onClick={() => navigate('/chat')}>
              <h3 className="text-lg font-bold text-gray-800">Direct Chat 💬</h3>
              <p className="text-sm text-gray-600 mt-2">Instantly message vendors to negotiate prices or check stock availability.</p>
            </Card>
          </div>
        </div>
