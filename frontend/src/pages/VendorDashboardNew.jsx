...
export const VendorDashboard = () => {
  ...
  const [products, setProducts] = useState([
    { id: 1, name: 'Fresh Tomatoes', price: 45, stock: 120, image: '/images/tomato.svg', status: 'Active', sold: 245 },
    { id: 2, name: 'Bell Peppers', price: 65, stock: 200, image: '/images/pepper.svg', status: 'Active', sold: 180 },
    { id: 3, name: 'Spinach Bundle', price: 25, stock: 50, image: '/images/spinach.svg', status: 'Low Stock', sold: 89 },
    { id: 4, name: 'Organic Carrots', price: 35, stock: 150, image: '/images/carrot.svg', status: 'Active', sold: 156 },
    { id: 5, name: 'Fresh Onions', price: 30, stock: 220, image: '/images/onion.svg', status: 'Active', sold: 234 },
    { id: 6, name: 'Green Beans', price: 55, stock: 80, image: '/images/beans.svg', status: 'Active', sold: 123 },
  ]);
